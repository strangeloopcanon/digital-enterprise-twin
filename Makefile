...
check: $(SETUP_STAMP)
	...
	. $(VENV)/bin/activate && mypy --follow-imports=skip vei/router/identity.py vei/router/tool_providers.py vei/identity vei/world/api.py vei/world/replay.py vei/router/api.py vei/workspace/api.py vei/run/api.py vei/twin vei/ui/api.py vei/context vei/synthesis vei/pilot vei/exercise vei/dataset vei/cli/vei.py vei/cli/vei_project.py vei/cli/vei_run.py vei/cli/vei_contract.py vei/cli/vei_scenario.py vei/cli/vei_inspect.py vei/cli/vei_ui.py vei/cli/vei_context.py vei/cli/vei_synthesize.py vei/cli/vei_pilot.py vei/cli/vei_exercise.py vei/cli/vei_dataset.py
